...
export const staffApi = {
  ...
  sendInvite: async (token: string | null, shopId: string, email: string, role: "owner" | "shop_worker"): Promise<StaffRequest> => {
    return await apiCall<StaffRequest>({
  ...
  removeStaff: async (token: string | null, shopId: string, memberId: string): Promise<any> => {
    return await apiCall<any>({
