...
const initialMockShops: Shop[] = [
  {
    ...
    invoiceCounter: 142,
    footerText: "Thank you for shopping at OnbilloGroceries! Visit again.",
    createdAt: new Date().toISOString(),
...
export const mockGlobalProducts: Product[] = [
  ...
  },
  {
    ...
    name: "Coca-Cola Classic Can 300ml",
    brand: "Coca-Cola",
    category: "Beverages",
    mrp: 4000,
    status: "approved",
  ...
  {
    id: "7",
    barcode: "8901396326524",
    name: "Dettol Liquid Handwash Refill 200ml",
    brand: "Reckitt",
      ...
      items: [
        {
          ...
          unitPrice: 2800,
          quantity: 2,
          productName: "Maggi 2-Min Masala Noodles",
        },
        {
          id: "2",
          billId: "1001",
          ...
          unitPrice: 3800,
          quantity: 1,
          productName: "Coca-Cola Classic Can 300ml",
        },
        {
          id: "3",
          billId: "1001",
...
export const mockStaffRequests: StaffRequest[] = [
  {
    ...
    status: "pending",
    createdAt: new Date().toISOString(),
    shopName: "Corner Cafe & Bakery",
    requesterName: "Ananya Sharma",
    receiverEmail: "kushal@onbillo.com",
    receiverName: "Kushal Kambar",
  },
  {
    id: "2",
    shopId: "1",
    ...
    status: "pending",
    createdAt: new Date().toISOString(),
    shopName: "OnbilloGroceries",
    requesterName: "Kushal Kambar",
    receiverEmail: "worker@kambar.com",
  ...
  },
  {
    ...
    shopName: "OnbilloGroceries",
    requesterName: "Kushal Kambar",
    receiverEmail: "accepted-worker@test.com",
    receiverName: "Accepted Worker",
  },
];

export const mockAdminUsers: any[] = [
  { ...mockUser, shopName: "OnbilloGroceries" },
  {
    id: "101",
    clerkId: "clerk_101",
    email: "ananya@cornercafe.com",
    phone: "+919988776655",
    name: "Ananya Sharma",
    role: "shop_owner",
    shopId: "2",
